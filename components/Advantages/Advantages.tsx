        ...
        {advantages.map((advantage) => {
          return (
            <div className="w-337px min-h-[263px] flex flex-col justify-center items-center mt-[45px]">
              ...
              <h3 className="mt-[47px] text-[#333333] text-[18px] font-bold tracking-[0.54px] leading-[25.2px]">
                {advantage.ingredient}
              </h3>
              <p className="mt-[15px] text-center text-[#707070] text-[14px] font-medium tracking-[0.42px] leading-[23.996px]">
                {advantage.desc}
              </p>
            </div>
          );
